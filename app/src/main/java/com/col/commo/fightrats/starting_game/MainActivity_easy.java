...
public class MainActivity_easy extends Activity implements View.OnClickListener {
    private int jf = 0;
    private TextView textView ;
    private ImageView integral,hole,hole1,hole2,hole3,hole4,hole5,ham1,ham2,ham3,ham4,ham5;
    ...
    public void initView(){
        ...
        integral=(ImageView) findViewById(R.id.add10);
        ...
        translate = AnimationUtils.loadAnimation(MainActivity_easy.this, R.anim.anim_translate_add10);
        pool = new SoundPool(2, AudioManager.STREAM_SYSTEM, 0);
        soundmap.put(1, pool.load(MainActivity_easy.this, R.raw.dalaoshu,1));
        soundmap.put(2, pool.load(MainActivity_easy.this, R.raw.enter,1));
        ...
        switch (v.getId()){
            ...
            case R.id.pause:
                ...
                home.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        dialog.dismiss();
                        Intent intent = new Intent(MainActivity_easy.this,Welcome.class);
    ...
    public void open_music(){
        ...
        mp = MediaPlayer.create(MainActivity_easy.this, R.raw.dalaoshu);
        mp.start();
    }
    ...
    public class MyThread extends Thread{
        ...
        public void run() {
            ...
            while(!Thread.currentThread().isInterrupted()){
                ...
                if (count >= 4){
                    Intent intent = new Intent(MainActivity_easy.this,Finish.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if(keyCode == KeyEvent.KEYCODE_BACK){
            new AlertDialog.Builder(MainActivity_easy.this)
                    .setCancelable(false)
                    .setMessage("你确定不玩了！！！")
